...
|---|---|---|---|
| `identity` | values, preferences, working style, voice | `01_Command Center/Identity` | preserve carefully; do not overwrite casually |
| `decision` | user choices, approved direction, rejected options | `01_Command Center/Decision Board`, project notes | cite decision date and reason |
...
| `relationship` | people, companies, roles, trust boundaries | `01_Command Center/_Organization`, `03_Operation/Client CRM` | avoid unnecessary personal details |
