...
전체 자동화 흐름은 [[Lua End-to-End Flow|Lua End-to-End Flow]]를 기준으로 본다. 기본 원격 명령 하달 장소는 [[09_Automations/Telegram Command Inbox|Telegram Command Inbox]]이고, 컴퓨터 앞에서 구조화해 적는 명령 장소는 [[01_Command Center/01_Commands/Obsidian Command Center|Obsidian Command Center]]다.
...
무엇을 Obsidian에 써야 하는지 애매하면 [[01_Command Center/04_Policies/Obsidian Writing Rules|Obsidian Writing Rules]]를 먼저 본다.
명령을 컴퓨터 앞에서 내리는지, 밖에서 Telegram으로 내리는지 애매하면 [[01_Command Center/01_Commands/Command Modes|Command Modes]]를 먼저 본다.

실사용 기준은 [[01_Command Center/04_Policies/Lua Operating Layers|Lua Operating Layers]]를 따른다:

- 기억할 것은 [[01_Command Center/02_Memory/Lua Memory Classification|Memory Classification]]
- 실행할 것은 [[01_Command Center/01_Commands/Lua Command Taxonomy|Command Taxonomy]]
- 끝난 일은 [[01_Command Center/03_Summaries/Lua Activity Summary System|Activity Summary System]]
...
| 해야 할 일 | 각 프로젝트의 `Backlog.md` 또는 [[01_Command Center/01_Commands/Urgent List|Urgent List]] | 실행 항목만 모으기 |
...
| 시스템 규칙 변경 | [[01_Command Center/03_Summaries/Work Ledger|Work Ledger]] | 어디서 누가 바꿨는지 추적 |
...
| Obsidian 안에 다음 실행 예약 | [[01_Command Center/00_Dashboard/Agent Dashboard|Agent Dashboard]]의 Quick Commands | `/project-sprint time-management-app first-demo` |
| 업무 도메인별 명령 하달 | [[01_Command Center/01_Commands/Obsidian Command Center|Obsidian Command Center]] | `/lua planning prioritize :: 이번 주 우선순위` |
| 프로젝트별 실행 큐 작성 | 프로젝트 `Backlog.md` | `/team-brief green-building` |
| 커밋/출처 기록 | [[01_Command Center/03_Summaries/Work Ledger|Work Ledger]] | `/work-log windows-codex cleanup` |
...
1. [[01_Command Center/00_Dashboard/Master Dashboard|Master Dashboard]]를 연다.
2. 오늘 처리할 프로젝트 Home 또는 Daily Notes를 연다.
3. 아직 정리 안 된 생각은 Inbox/Daily Notes에 먼저 적는다.
4. 바로 실행할 명령은 [[01_Command Center/01_Commands/Obsidian Command Center|Obsidian Command Center]]에 적는다.
