...
| 업무 도메인별 명령 하달 | [[01_Command Center/Obsidian Command Center|Obsidian Command Center]] | `/lua planning prioritize :: 이번 주 우선순위` |
...
4. 바로 실행할 명령은 [[01_Command Center/Obsidian Command Center|Obsidian Command Center]]에 적는다.
