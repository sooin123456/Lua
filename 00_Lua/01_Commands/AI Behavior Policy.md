...
|---|---|---|---|
| Memory | 나중에 무엇을 기억해야 하지? | `90_System/80_Lua_Details/00_Inbox`, `90_System/03_Wiki`, `90_System/80_Lua_Details/04_Resources`, project notes | [[00_Lua/02_Memory/Memory Classification|Lua Memory Classification]] |
| Command | 이 명령은 어떤 종류이고 어떤 AI 행동 방침이 필요하지? | `90_System/09_Automations`, `00_Lua/01_Commands`, runtime DB | [[00_Lua/01_Commands/Command Types|Lua Command Taxonomy]] |
| Summary | 오늘/이번 작업에서 무엇을 했고 다음은 무엇이지? | `00_Lua/01_Commands`, project `DevLog`, `90_System/docs/development-log.md` | [[00_Lua/03_Records/Activity Summary System|Lua Activity Summary System]] |
...
- [[00_Lua/03_Records/Activity Summary System|Activity Summary]]
