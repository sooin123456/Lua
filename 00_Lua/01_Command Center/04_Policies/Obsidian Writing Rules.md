...
| 상황 | 행동 | 위치 |
|---|---|---|
| 갑자기 아이디어가 떠오름 | 원문 그대로 적기 | [[00_Lua/00_Inbox/AI 분류 대기중...|AI 분류 대기중]] |
| 아이디어가 프로젝트가 될 수 있음 | 왜 필요한지, 첫 결과물, 다음 행동 적기 | 프로젝트 `Home.md` 또는 새 후보 노트 |
| 오늘 한 일/결정 | 짧게 로그 남기기 | [[00_Lua/05_Personal Studio/Daily Notes|Daily Notes]] |
...
| 팀에게 공유해야 함 | 초안 만들기 | [[00_Lua/03_Operation/Team Brief Drafts|Team Brief Drafts]] |
| 재사용 가능한 결과물이 생김 | artifact로 등록 | [[90_System/08_Artifacts/Artifact Ledger|Artifact Ledger]] |
| Codex/Claude가 파일을 바꿈 | 출처와 커밋 남기기 | [[00_Lua/01_Command Center/03_Summaries/Work Ledger|Work Ledger]] |
...
| "이건 바로 시킬 수 있다" | [[00_Lua/01_Command Center/01_Commands/Obsidian Command Center|Obsidian Command Center]]에 명령 작성 | Atlas CEO 라우팅 |
...
```bash
node 90_System/scripts/add_inbox_capture.js --source manual "떠오른 생각"
```
