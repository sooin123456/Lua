...
Obsidian에서 쓰는 기본 명령은 [[00_Lua/01_Command Center/01_Commands/Obsidian Command Center|Obsidian Command Center]]의 `/lua {domain} {intent} :: {payload}` 형식을 따른다.
...
- Slack으로 나가는 메시지는 [[00_Lua/03_Operation/Team Brief Drafts|Team Brief Drafts]]에서 approved 상태가 되어야 한다.
