...
|---|---|---|---|
| `identity` | values, preferences, working style, voice | `00_Lua/02_Memory/Identity` | preserve carefully; do not overwrite casually |
| `decision` | user choices, approved direction, rejected options | `90_System/80_Lua_Details/01_Command Center/01_Commands/Decision Board`, project notes | cite decision date and reason |
| `project-context` | goals, scope, constraints, current next action | `90_System/80_Lua_Details/02_Projects/**/Home.md`, `90_System/80_Lua_Details/02_Projects/Lua/*` | update when project state changes |
| `relationship` | people, companies, roles, trust boundaries | `90_System/80_Lua_Details/01_Command Center/02_Memory/_Organization`, `90_System/80_Lua_Details/03_Operation/Client CRM` | avoid unnecessary personal details |
| `research` | sources, market facts, vendor facts, technical references | `90_System/80_Lua_Details/04_Resources`, project `Research.md`, `90_System/80_Lua_Details/03_Operation/Industry Intelligence` | keep source and date |
| `idea` | unvalidated concepts, possible products, prompts | `90_System/80_Lua_Details/00_Inbox`, `90_System/80_Lua_Details/05_Personal Studio/Ideas` | do not treat as commitment |
...
| Random app idea | `idea` | `90_System/80_Lua_Details/00_Inbox` or Ideas |
