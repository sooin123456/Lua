...
## 2026-08-01 KST - restore Lua Railway command gateway

- Host: `codex`
- Agent: `Codex`
- Repo/area: Lua Cloud Main, Railway, Telegram
- Trigger: user chose Railway as the always-on Telegram entry for Lua
- Changed: reconciled the local workspace with the existing Lua vault, retained the established Railway + Supabase runtime, and added a Telegram chat allowlist check before command processing
