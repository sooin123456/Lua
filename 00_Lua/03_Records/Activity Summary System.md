...
| `work-ledger` | who changed what, where, and verification | [[00_Lua/03_Records/Work Ledger|Work Ledger]] | every system/repo change |
| `project-devlog` | project-specific implementation history | project `DevLog.md` or app repo 90_System/docs | every project change |
| `daily-summary` | what happened today across areas | [[90_System/80_Lua_Details/05_Personal Studio/Daily Notes|Daily Notes]] or Weekly Review | daily or on demand |
| `weekly-review` | decisions, shipped work, open loops | [[00_Lua/03_Records/Weekly Review|Weekly Review]] | weekly |
...
- [[90_System/80_Lua_Details/05_Personal Studio/Daily Notes|Daily Notes]]
