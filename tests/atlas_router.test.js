...
| cmd-20260516-024544 | planning | prioritize | 이번 주 Lua 구축 우선순위 정리 | clarify | Atlas | planned | [[01_Command Center/01_Commands/Command Runs/cmd-20260516-024544-planning-prioritize|run]] |
| inbox-20260516-031554-01 | build | app | Neural UI 사업 아이디어 | clarify | Forge | planned | [[01_Command Center/01_Commands/Command Runs/inbox-20260516-031554-01-build-app|run]] |
`
  );
  write(
    path.join(root, '01_Command Center', '01_Commands', 'Command Runs', 'cmd-20260516-024544-planning-prioritize.md'),
    `---
type: command-run
status: planned
...
`
  ...
  write(
    path.join(root, '01_Command Center', '00_Dashboard', 'User Action Board.md'),
    `---
type: action-board
status: active
last_updated: 2026-05-16
...
| ID | Domain | Intent | Payload | Stage | Owner | Status | Result |
|---|---|---|---|---|---|---|---|
| inbox-20260516-031554-01 | build | app | 카파시 인터뷰 기반 Neural UI 사업 아이디어. Toss 미니앱 같은 예시. | clarify | Forge | planned | [[01_Command Center/01_Commands/Command Runs/inbox-20260516-031554-01-build-app|run]] |
| inbox-20260516-031554-02 | research | brief | 수상태양광 리서치 | clarify | Lens | planned | [[01_Command Center/01_Commands/Command Runs/inbox-20260516-031554-02-research-brief|run]] |
`
  );
  write(
    path.join(root, '01_Command Center', '01_Commands', 'Command Runs', 'inbox-20260516-031554-01-build-app.md'),
    `---
type: command-run
status: planned
...
| ID | Domain | Intent | Payload | Stage | Owner | Status | Result |
|---|---|---|---|---|---|---|---|
| inbox-20260516-031554-02 | research | brief | 수상태양광 미팅. K-water 발주 사이즈, 협력 가능 업체, 경쟁사, 테크인 조사가 필요함. | clarify | Lens | planned | [[01_Command Center/01_Commands/Command Runs/inbox-20260516-031554-02-research-brief|run]] |
`
  );
  write(
    path.join(root, '01_Command Center', '01_Commands', 'Command Runs', 'inbox-20260516-031554-02-research-brief.md'),
    `---
type: command-run
status: planned
...
| ID | Domain | Intent | Payload | Stage | Owner | Status | Result |
|---|---|---|---|---|---|---|---|
| inbox-20260516-041614-01 | design | screen | Toss 미니앱 만들기: https://toss.im/apps-in-toss/blog/making-miniapps 토스 미니앱 만들기 주제는 아직 고민중 대신 이번에는 디자인 쪽으로 나의 명령 체계를 ui로 표현해주는 서비스 | clarify | Scribe+Forge | planned | [[01_Command Center/01_Commands/Command Runs/inbox-20260516-041614-01-design-screen|run]] |
`
  );
  write(
    path.join(root, '01_Command Center', '01_Commands', 'Command Runs', 'inbox-20260516-041614-01-design-screen.md'),
    `\uFEFF---
type: command-run
status: planned
