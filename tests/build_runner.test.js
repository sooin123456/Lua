...
|---|---|---|---|---|---|---|---|
| build-001 | build | app | Make a tiny timer app from the Lua template | plan | Forge | routed | [[01_Command Center/01_Commands/Command Runs/build-001-build-app|run]] |
`
  );
  write(
    path.join(root, '01_Command Center', '01_Commands', 'Command Runs', 'build-001-build-app.md'),
    `---
type: command-run
status: routed
...
`
  ...
  write(
    path.join(root, '01_Command Center', '03_Summaries', 'Work Ledger.md'),
    `# Work Ledger
`
  );
  return root;
