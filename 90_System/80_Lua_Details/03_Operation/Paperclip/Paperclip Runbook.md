...
- Command Center: `[[90_System/80_Lua_Details/01_Command Center/00_Dashboard/Master Dashboard|Master Dashboard]]`, `[[90_System/80_Lua_Details/01_Command Center/00_Dashboard/Agent Dashboard|Agent Dashboard]]`
- Projects: `[[90_System/80_Lua_Details/02_Projects/Projects Hub|Projects Hub]]`
- Operation: `[[90_System/80_Lua_Details/03_Operation/Operation Hub|Operation Hub]]`
- Review: `[[00_Lua/03_Records/Weekly Review|Weekly Review]]`

## 5) 최소 운영 루틴 (권장)

1. Telegram 메시지 수집 (`00_Lua/00_Inbox`)
...
- 오프셋 저장: `90_System/80_Lua_Details/03_Operation/Paperclip/telegram_offset.txt`
...
- 출력 파일: `90_System/80_Lua_Details/00_Inbox/Notion_Digest_YYYYMMDD.md`
