...
Slack 전송은 온라인 명령이다. 실행 전 [[90_System/80_Lua_Details/01_Command Center/01_Commands/Command Modes|Command Modes]]를 따른다.
...
Next:
- 승인되면 `status: approved`로 바꾸고 `node 90_System/scripts/slack_brief.js --confirm-send`를 실행합니다.
<!-- /slack-brief -->
