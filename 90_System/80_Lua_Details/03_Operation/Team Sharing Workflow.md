...
Obsidian에서 정리한 내용을 Notion과 Notion으로 공유하는 기준을 정한다.

## Principle

- Obsidian: 원본 기록, 개인 사고, 상세 맥락.
- Notion: 팀이 반복해서 확인하는 운영 DB와 정리본.
- Notion: 지금 봐야 하는 알림, 승인 요청, 요약.

Notion과 Notion은 Obsidian을 대체하지 않는다. Obsidian에서 정리한 뒤 필요한 만큼만 팀에게 보낸다.
...
4. Publish: Notion에는 구조화된 페이지/DB로에는 짧은 알림으로 보낸다.
5. Log: 공유한 내용과 출처를 Work Ledger 또는 프로젝트 DevLog에 남긴다.

## What Goes Where

| 내용 | Obsidian | Notion | Notion |
|---|---|---|---|
| 원본 아이디어 | yes | no | no |
...
|---|---|---|
| Projects | 프로젝트 상태판 | `90_System/80_Lua_Details/02_Projects/**/Home.md` |
...
| Artifacts | 재사용 산출물 | `90_System/08_Artifacts/Artifact Ledger.md` |
| Team Briefs | Notion 공유 초안 | `90_System/80_Lua_Details/03_Operation/Team Brief Drafts.md` |
