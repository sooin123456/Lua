...
|---|---|
| App name | `돈 먹는 먼지` |
| Repo boundary | `Lua` = system/90_System/docs, `Lua_money_dust` = app |
...
- [x] Create durable product spec: [[90_System/80_Lua_Details/02_Projects/TOSS/Money Eating Dust|돈 먹는 먼지]]
- [x] Register command run.
- [x] Create separate TOSS project: [[90_System/80_Lua_Details/02_Projects/TOSS/Home|TOSS]].
...
- [x] Update `Lua` 90_System/docs so they reference the app repo instead of storing app artifacts.
...
- [[90_System/80_Lua_Details/02_Projects/TOSS/Money Eating Dust|돈 먹는 먼지]]
- [[90_System/80_Lua_Details/02_Projects/TOSS/Submission Package|Submission Package]]
