...
- [x] 첫 처리 대상: [[90_System/80_Lua_Details/Command Runs/inbox-20260516-041614-01-design-screen|inbox-20260516-041614-01]].
- [x] Toss 미니앱 링크와 Inbox 메모를 기반으로 Lua Command UI 문제를 정의.
- [x] 첫 MVP를 "명령 작성기" 화면으로 제한.
- [x] 화면 설계 노트 생성: [[90_System/80_Lua_Details/02_Projects/Lucia/Lua Command UI|Lua Command UI]].
