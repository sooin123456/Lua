...
- [x] command run 생성: [[90_System/80_Lua_Details/Command Runs/easy-ai-helper-20260516-01-build-app|easy-ai-helper-20260516-01]].
- [x] 제품 기획 노트 생성: [[90_System/80_Lua_Details/02_Projects/Lucia/Easy AI Helper Miniapp|Easy AI Helper Miniapp]].
...
| Field | Value |
|---|---|
| Product spec | [[90_System/80_Lua_Details/02_Projects/Lucia/Easy AI Helper Miniapp|Easy AI Helper Miniapp]] |
| MVP scope | 사기 문자 확인, 안내문 쉽게 설명, 안전 답장 만들기 |
| Template baseline | [[90_System/09_Automations/App Template Standard|Lua_template]] |
