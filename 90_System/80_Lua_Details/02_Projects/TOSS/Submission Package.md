...
| Project | [[90_System/80_Lua_Details/02_Projects/TOSS/Home|TOSS]] |
...
Official Apps in Toss 90_System/docs require a WebView/RN bundle path, not a plain public web URL. For this repo the local path is now:
...
Official 90_System/docs reviewed:
...
- Product spec: [[90_System/80_Lua_Details/02_Projects/TOSS/Money Eating Dust|돈 먹는 먼지]]
- Submission draft: [[90_System/80_Lua_Details/05_Personal Studio/_Drafts/Money Eating Dust Toss Submission Draft|Money Eating Dust Toss Submission Draft]]
- Decision Board: [[90_System/80_Lua_Details/01_Command Center/01_Commands/Decision Board|Decision Board]]
