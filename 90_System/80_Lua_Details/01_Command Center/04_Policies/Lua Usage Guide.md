...
전체 자동화 흐름은 [[Lua End-to-End Flow|Lua End-to-End Flow]]를 기준으로 본다. 기본 원격 명령 하달 장소는 [[90_System/09_Automations/Telegram Command Inbox|Telegram Command Inbox]]이고, 컴퓨터 앞에서 구조화해 적는 명령 장소는 [[00_Lua/01_Commands/Command Inbox|Obsidian Command Center]]다.
...
명령을 컴퓨터 앞에서 내리는지, 밖에서 Telegram으로 내리는지 애매하면 [[90_System/80_Lua_Details/01_Command Center/01_Commands/Command Modes|Command Modes]]를 먼저 본다.

실사용 기준은 [[00_Lua/01_Commands/AI Behavior Policy|Lua Operating Layers]]를 따른다:

- 기억할 것은 [[00_Lua/02_Memory/Memory Classification|Memory Classification]]
- 실행할 것은 [[00_Lua/01_Commands/Command Types|Command Taxonomy]]
- 끝난 일은 [[00_Lua/03_Records/Activity Summary System|Activity Summary System]]

## Where To Write

| 상황 | 쓰는 곳 | 이유 |
|---|---|---|
| 갑자기 떠오른 아이디어 | [[90_System/80_Lua_Details/00_Inbox/AI 분류 대기중...|AI 분류 대기중]] 또는 새 Inbox 노트 | 아직 프로젝트가 아니므로 임시 보관 |
| 오늘 한 일 | [[90_System/80_Lua_Details/05_Personal Studio/Daily Notes|Daily Notes]] | 개인 작업 흐름 기록 |
...
| Obsidian 안에 다음 실행 예약 | [[90_System/80_Lua_Details/01_Command Center/00_Dashboard/Agent Dashboard|Agent Dashboard]]의 Quick Commands | `/project-sprint time-management-app first-demo` |
| 업무 도메인별 명령 하달 | [[00_Lua/01_Commands/Command Inbox|Obsidian Command Center]] | `/lua planning prioritize :: 이번 주 우선순위` |
| 프로젝트별 실행 큐 작성 | 프로젝트 `Backlog.md` | `/team-brief green-building` |
| 커밋/출처 기록 | [[00_Lua/03_Records/Work Ledger|Work Ledger]] | `/work-log windows-codex cleanup` |
...
1. [[90_System/80_Lua_Details/01_Command Center/00_Dashboard/Master Dashboard|Master Dashboard]]를 연다.
2. 오늘 처리할 프로젝트 Home 또는 Daily Notes를 연다.
3. 아직 정리 안 된 생각은 Inbox/Daily Notes에 먼저 적는다.
4. 바로 실행할 명령은 [[00_Lua/01_Commands/Command Inbox|Obsidian Command Center]]에 적는다.
...
- [[90_System/80_Lua_Details/04_Resources/Tech Stack/Pi Coding Agent|Pi Coding Agent]]
