...
- 90_System/80_Lua_Details/02_Projects/ 사업이 어느 법인 사업인지 명시 (project frontmatter에 `owner_entity` 또는 `consortium_pattern`)
...
- THEKIE 본체: `theKIE.md`
- KGCT 정체: `KGCT.md`
- proposal-drafting (이 컨텍스트 사용): `90_System/07_Lua_System/verticals/climate-energy/skills/proposal-drafting/SKILL.md`
