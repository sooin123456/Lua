...
const INBOX_REL = path.join('90_System/09_Automations', 'Telegram Command Inbox.md');
...
function usage() {
  console.log(`Usage:
  node 90_System/scripts/telegram_command_inbox.js "/lua research brief :: 테크인 조사"
