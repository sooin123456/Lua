...
function usage() {
  console.log(`Usage:
  TELEGRAM_BOT_TOKEN=... node 90_System/scripts/telegram_bot_poll.js --once
  TELEGRAM_BOT_TOKEN=... TELEGRAM_ALLOWED_CHAT_IDS=123,456 node 90_System/scripts/telegram_bot_poll.js --once --ack
  TELEGRAM_BOT_TOKEN=... node 90_System/scripts/telegram_bot_poll.js --watch --timeout 25
`);
}
