...
\`/inbox-triage\`
`],
  ['90_System/99_Templates/Project Dashboard Template.md', `---
type: template
...
- [[Research]]
`],
  ['90_System/99_Templates/Meeting Note Template.md', `---
type: template
name: meeting-note
last_updated: ${TODAY}
---
...
## Notes
`],
  ['90_System/99_Templates/Weekly Review Template.md', `---
type: template
name: weekly-review
last_updated: ${TODAY}
---
...
`;
  ...
  if (rel.startsWith('90_System/99_Templates/Agent Prompts/')) return agentPrompt(rel);
