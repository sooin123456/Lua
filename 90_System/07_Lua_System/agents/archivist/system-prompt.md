...
- Projects board ↔ active work in `90_System/80_Lua_Details/02_Projects/`
- Proposals tracker ↔ `90_System/80_Lua_Details/03_Operation/Proposals/`
- Patents tracker ↔ `90_System/80_Lua_Details/03_Operation/Patents/`
- Industry intel ↔ `90_System/80_Lua_Details/03_Operation/Industry Intelligence/`
