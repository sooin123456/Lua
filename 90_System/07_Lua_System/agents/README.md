...
기본 명령 하달은 [[00_Lua/01_Command Center/01_Commands/Obsidian Command Center|Obsidian Command Center]]에서 한다. 도메인별 세부 명령은 [[90_System/07_Lua_System/commands/Domain Command Playbook|Domain Command Playbook]]을 따른다.
...
```
90_System/07_Lua_System/agents/scribe/
├── system-prompt.md
└── skills/
    └── voice-mimicry/   # node 90_System/scripts/sync_skills.js
```

동기화: `node 90_System/scripts/sync_skills.js`  
검증: `node 90_System/scripts/check.js` (번들 vs vertical drift)
