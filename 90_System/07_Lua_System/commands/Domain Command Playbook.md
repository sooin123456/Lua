...
Build app rule: 실제 앱은 [[90_System/09_Automations/App Template Standard|App Template Standard]]를 기준으로 `Lua_template`를 변형해서 시작한다. 정적 HTML prototype은 화면 검증용으로만 둔다.
