...
The next workspace structure is defined in [[90_System/09_Automations/Notion Workspace Plan|Notion Workspace Plan]].

Notion publishing is Phase 4 in [[Lua End-to-End Flow|Lua End-to-End Flow]]. It is not active by default yet.

The first safe integration step is [[90_System/09_Automations/Notion Publish Queue|Notion Publish Queue]]. It creates approval-ready local drafts before any Notion write.
