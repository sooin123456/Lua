...
Do not create these automatically yet. Use `[[90_System/09_Automations/Notion Publish Queue|Notion Publish Queue]]` first, then create databases once the fields stabilize.
...
1. Obsidian note becomes a local draft in `[[90_System/09_Automations/Notion Publish Queue|Notion Publish Queue]]`.
