    ...
    async (url, options) => {
      ...
      return {
        ...
        json: async () => ({
          ...
          status: 'routed',
          stage: 'plan',
          run: '00_Lua/01_Command Center/01_Commands/Command Runs/lua-ui-20260516-134530-build-app',
        }),
      };
    },
    ...
    async (url, options) => {
      ...
      return {
        ...
        json: async () => ({
          ...
          status: 'done',
          stage: 'brief',
          artifact: '90_System/08_Artifacts/Build Outputs/lua-ui-20260516-134530-build-app-output',
        }),
      };
    },
    { protocol: 'http:', hostname: '127.0.0.1' },
