...
test('builds a Lua Command UI command into an artifact from one localhost API call', () => {
  ...
  assert.equal(
    result.artifact,
    '90_System/08_Artifacts/Build Outputs/lua-ui-20260516-134530-build-app-output'
  );

  const artifact = fs.readFileSync(
    path.join(root, '90_System/08_Artifacts', 'Build Outputs', 'lua-ui-20260516-134530-build-app-output.md'),
    'utf8'
  );
