...
- Create `lua_agent/__init__.py`: package version export.
- Create `lua_agent/models.py`: Pydantic models and enums for projects, tasks, checkpoints, agents, and tool instructions.
- Create `lua_agent/storage.py`: SQLite schema and repository methods.
- Create `lua_agent/obsidian.py`: markdown export for project logs.
- Create `lua_agent/codex.py`: Codex `/goal` prompt generator.
- Create `lua_agent/cli.py`: Typer CLI commands.
- Create `tests/test_models.py`: model behavior tests.
- Create `tests/test_storage.py`: SQLite persistence tests.
- Create `tests/test_obsidian.py`: Obsidian markdown export tests.
- Create `tests/test_codex.py`: Codex goal generator tests.
- Create `tests/test_cli.py`: CLI smoke tests.
- Modify `docs/development-log.md`: add MVP implementation entry.

## Task 1: Project Skeleton And Domain Models

**Files:**
- Create: `pyproject.toml`
- Create: `lua_agent/__init__.py`
- Create: `lua_agent/models.py`
...
```bash
git add pyproject.toml lua_agent/__init__.py lua_agent/models.py tests/test_models.py
...
```bash
git add lua_agent/storage.py tests/test_storage.py
...
```bash
git add lua_agent/obsidian.py tests/test_obsidian.py
...
```bash
python -m pytest tests/test_codex.py -v
```
...
```bash
git add lua_agent/codex.py tests/test_codex.py
...
```python
# Add this method to lua_agent/storage.py inside SQLiteStore.
...
```bash
git add lua_agent/cli.py lua_agent/storage.py tests/test_cli.py docs/development-log.md
