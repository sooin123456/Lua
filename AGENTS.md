...
3. `01_Command Center/01_Commands/Harness Loop.md`
...
- Store Pi decisions in `04_Resources/Tech Stack/Pi Coding Agent.md` and user-facing usage rules in `01_Command Center/04_Policies/Lua Usage Guide.md`.

## Default Build Loop

Use the loop in `01_Command Center/01_Commands/Harness Loop.md`:
...
- Append to `01_Command Center/03_Summaries/Work Ledger.md`.
...
- `01_Command Center/02_Memory/Identity/` is read-only unless the user approves the exact file edit.
- `01_Command Center/04_Policies/_System/` is read-only unless the user asks for permission changes.
